...
@Results({
    ...
    @Result(name="input",type= ServletDispatcherResult.class,value="/WEB-INF/jsp/community/listSubscribeCommunity.jsp")
})
public class SubscribeCommunityAction extends BaseCommunityAction implements ServletRequestAware {
...
//    )
    public String execute() throws Exception {
    	...
    	service.subscribeUser(community,""+user.getId());
        return SUCCESS;
    }
}
