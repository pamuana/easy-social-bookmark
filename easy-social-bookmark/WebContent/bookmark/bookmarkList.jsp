...
%>
		    ...
		    <div class="commands"><a href="../community/viewcommunity.jsp?idBookmark=<%=bm.getId()%>">share</a>,<a href="bookmarkForm.jsp?idBookmark=<%=bm.getId()%>">edit</a>,<a href="viewcommunity.jsp?idBookmark=<%= bm.getId() %>">delete</a></div>
<%
